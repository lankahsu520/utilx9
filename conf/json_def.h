...
#define JVAL_NAME_MAC_ADDRESS                     "MAC Address"
#define JVAL_NAME_GROUPID                         "Group ID"
#define JVAL_NAME_PROTOCOLID                      "Protocol ID"
#define JVAL_NAME_UUID                            "UUID"
...
#define JVAL_NAME_WAKE_UP_INTERVAL                "Wakeup Interval"
